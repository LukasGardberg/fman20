...
features(i) = has_holes(I);
i = i + 1;
features(i) = has_two_holes(I);
i = i + 1;

features(i) = measure_symmetry(I);
i = i + 1;

features(i) = count_middle(I);
i = i + 1;
...
i = i + 1;
features(i) = count_pixels_in_half(I, 'up'); % 13
i = i + 1;
...
features(i) = (props.MinorAxisLength-4)/13;
i = i + 1;
features(i) = (props.Circularity-0.15)/0.6; 
i = i + 1;
...
function x = count_pixels_in_dim(im, dim)
    ...
    % Original idea useless when cropping image with bounding box
